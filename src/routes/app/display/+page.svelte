...
<div
	class="grid h-[100vh] w-[100vw] grid-cols-4 grid-rows-5 gap-[1vw] bg-slate-100 px-[3vw] py-[3vh] dark:bg-slate-800"
>
...
>
	<div class="component"><DateTime /></div>
	<div class="component row-span-5"><Calendar /></div>
	<div class="component col-span-2 row-span-4"><Art /></div>
	<div class="component row-span-2"><Photo /></div>
	<div class="component row-span-2"><Weather /></div>
	<div class="component"><Math /></div>
	<div class="component"><Sentence /></div>
...
<style lang="postcss">
	/* .component {
		@apply overflow-hidden rounded-lg bg-black/80 p-[20px] text-2xl text-white shadow-lg;
	} */
